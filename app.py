...
def load_data():
    ...
    df_raw.rename(columns={'date': 'Date', 'laid_off_date': 'Date',
                  'Date_Added': 'Date', 'date_added': 'Date'}, inplace=True)
...
# mouse hover shows both lines' values at once
...
with st.expander("See Raw Data"):
    st.dataframe(filtered_pred)
>>>>>>> 7b5c2284aaa956f6c4e5706f8a01de645f088ed1
